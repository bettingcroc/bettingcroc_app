...
class OptionPool extends React.Component {
  ...
  approveUSDT(amount) {
    this.props.usdtContract.methods.approve("0x356d98D7461362c6670c55038A1f76CB2Df98ad4", weiconvert(amount)).send({ from: this.props.address })
  ...
  render() {
    return (
      <div className="optionPool">
        <button className="buttonTeamTitle" onClick={(event) => { /*this.betOnThisOption(this.state.amountToBet)*/  this.setBet(); }}><p className='teamTitle'>{this.props.team}</p></button>
