import { API_KEY, GAS_PRICE, web3, NODES_URL_BSCTESTNET, PRIVATE_KEY_CREATOR, PUBLIC_KEY_CREATOR, multiBetAddress, NODE_URL_BSCTESTNET, NODE_URL_POLYGON, multiBetABI, newBetCreatedABI } from "../config.js"
...
const betToCreates = [
    {
        ...
        "leagues": [
            ...
            {"name": "MLS","id":"332","country":"USA"},
            {"name": "Brazil - Serie A","id":"99","country":"Brazil"},
            {"name": "Copa America 2024","id":"17","country":"SOuth America"},
        ],
        "numberOfOptions": 3,
